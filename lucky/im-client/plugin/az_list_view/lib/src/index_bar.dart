...
const double kIndexBarWidth = 60;

const double kIndexBarItemHeight = 15.5;
...
class IndexBarOptions {
  ...
  const IndexBarOptions({
    ...
    this.selectItemDecoration = const BoxDecoration(
  ...
  void _addOverlay(BuildContext context) {
    ...
    if (overlayEntry == null) {
      overlayEntry = OverlayEntry(builder: (BuildContext ctx) {
        ...
        top = (widget.indexBarDragNotifier?.dragDetails.value.globalPositionY ??
                0) -
            widget.options.indexHintHeight / 3;
