...
class AzListView extends StatefulWidget {
  AzListView({
    ...
    this.showIndexBar = false, required this.noResultFound,
  }) : super(key: key);
...
class _AzListViewState extends State<AzListView> {
  ...
  void initState() {
    ...
    //   if (cellSize == 0)
    //     cellSize =
    //         positions.first.itemTrailingEdge - positions.first.itemLeadingEdge;
    //
    //   if (positions.isNotEmpty) {
    //     ItemPosition firstItemPosition = positions
    //         .where((ItemPosition position) =>
    //             position.itemTrailingEdge > cellSize / 2)
    //         .reduce((ItemPosition min, ItemPosition position) =>
    //             position.itemTrailingEdge < min.itemTrailingEdge
    //                 ? position
    //                 : min);
    //
    //     ItemPosition lastItemPosition = positions
    //         .where((ItemPosition position) =>
    //             position.itemLeadingEdge < 1 - cellSize / 2)
    //         .reduce((ItemPosition max, ItemPosition position) =>
    //             position.itemLeadingEdge < max.itemLeadingEdge
    //                 ? max
    //                 : position);
    //
    //     firstVisibleIndex = firstItemPosition.index;
    //     lastVisibleIndex = lastItemPosition.index;
    //   }
    // });
  }
    ...
    return Stack(
      children: [
        SuspensionView(
          ...
          physics: widget.physics, noResultFound: widget.noResultFound,
        ),
