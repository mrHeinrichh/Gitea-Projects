...
class SuspensionView extends StatefulWidget {
  SuspensionView({
    ...
    this.susPosition,
    this.physics,
    this.padding, required this.noResultFound,
  }) : super(key: key);
                ...
                itemBuilder: (context, index) {
                  ...
                  if (widget.itemCount > 0) {
                    if (index ==
                        widget.itemCount +
                            (widget.listHeader != null ? 1 : 0)) {
                      return widget.listFooter ?? const SizedBox();
                    } else {
                      return _buildItem(
                        context,
                        index - (widget.listHeader != null ? 1 : 0),
                      );
                    }
                  } else {
