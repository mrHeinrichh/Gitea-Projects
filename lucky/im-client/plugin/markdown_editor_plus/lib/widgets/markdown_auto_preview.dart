...
class MarkdownAutoPreview extends StatefulWidget {
  ...
  /// TextField default hint text
  ///
  /// If It doesn't have text currently, It can show this hint text
  ///
  final String? hintText;

  /// The preview's padding before edit it
  ///
  /// If the value is null, default 0
  ///
      ...
      child: _focused
          ...
          : GestureDetector(
              ...
              child: Align(
                ...
                child: _internalController.text == "" && widget.hintText != null ? Padding(
                  padding: widget.previewPadding != null ? widget.previewPadding! : const EdgeInsets.symmetric(
                    vertical: 10,
                  ),
                  child: Text(
                      widget.hintText!,
