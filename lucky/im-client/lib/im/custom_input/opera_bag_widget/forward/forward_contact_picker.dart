...
import '../../../../views_desktop/component/desktop_forward_controller.dart';
import '../../../../views_desktop/component/desktop_general_button.dart';
import '../../../../views_desktop/component/desktop_searching_bar.dart';
...
class _ForwardContactPickerState extends State<ForwardContactPicker> {
  ...
  void initState() {
    ...
    _contactList.clear();
    _contactList =
        objectMgr.userMgr.friendWithoutBlacklist.where((e) => e.deletedAt == 0).toList();
    updateAZFriendList();
    if (mounted) {
      setState(() {});
    }
  ...
  void onForwardAction(
      BuildContext context, User user, List<dynamic> forwardData) async {
    Chat? chat =
                  ...
                  () => desktopForwardController.chatList.isNotEmpty &&
                      ...
                      ? ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Center(
                              child: Text(
                                'You have no forward target currently.',
                                style: TextStyle(
                                  color: Colors.grey,
                                  fontSize: 12,
                                  fontWeight:MFontWeight.bold4.value,
