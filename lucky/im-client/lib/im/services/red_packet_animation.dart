...
class RedPacketCardClip extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.save();
    canvas.clipRect(
      Rect.fromLTRB(size.width - (isMessage ? 20 : 50), 0, size.width,
          isMessage ? 20 : 50),
    );
                  ...
                  ? Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            localized(congratulationsYouHaveClaimedThisRedPacket),
                            style: TextStyle(
                              color: Color(0xFFF79A44),
                              fontSize: 12.0,
                              decoration: TextDecoration.none,
                  ...
                  : Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            localized(youHaveFailedToClaimedTheRedPacketWithinTheTimeFrame),
                            style: TextStyle(
                              color: Colors.black,
                              fontSize: 14.0,
                              decoration: TextDecoration.none,
