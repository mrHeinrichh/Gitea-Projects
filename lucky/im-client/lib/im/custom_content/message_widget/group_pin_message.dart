...
class _GroupPinMessageState extends State<GroupPinMessage>
      ...
      () => isExpired.value
          ...
          : Align(
              ...
              child: Container(
                ...
                child: Text(
                  '${firstNameIsMe ? localized(chatInfoYou) : objectMgr.userMgr.getUserTitle(objectMgr.userMgr.getUserById(widget.messagePin.sendId))} ${getMessageContent(widget.messagePin)}',
