...
import 'package:im/widget/message/im_message_20005.dart';

import '../message_widget/message_widget_mixin.dart';
import 'message_item_ui_component.dart';

class MessageItemUITypeBetStatistics extends MessageItemUIComponent {
  MessageItemUITypeBetStatistics(
      {super.key,
