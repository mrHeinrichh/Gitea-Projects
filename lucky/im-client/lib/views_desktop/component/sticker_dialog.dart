...
import '../../managers/sticker_mgr.dart';
...
class _StickerDialogState extends State<StickerDialog>
  ...
  void scrollToSpecificPosition(int index) async {
    ...
    final animateDuration = const Duration(milliseconds: 100);
    final curves = Curves.easeInOutCubic;
  ...
  Widget buildTabItem(
      IconData icon, Color tabColor, Color iconColor, String label) {
    return Tab(
      child: Container(
        color: tabColor,
  ...
  Widget buildTabItemWithImage(String imageUrl, Color tabColor, String label,
