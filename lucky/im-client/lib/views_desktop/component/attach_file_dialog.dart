...
import 'attach_file_controller.dart';
        ...
        if (controller.files.length > 1) {
          ...
          if (fileType == FileType.document) {
            ...
            if (mediaType == FileType.image)
              return imageItem();
            else if (mediaType == FileType.video) return videoItem();
          }
        }
        Get.back();
              ...
              children: <Widget>[
                Container(
                  ...
                  decoration: const ShapeDecoration(
                    shape: CircleBorder(),
                    color: JXColors.chatBubbleMeAccentColor,
                  ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: <Widget>[
                      Text(
                        controller.files[index].path.split('/').last,
                        style: TextStyle(
                          fontSize: 12,
