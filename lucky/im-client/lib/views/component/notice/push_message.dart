...
class PushMessage extends StatefulWidget {
  ...
  const PushMessage({Key? key, required this.data, required this.callback})
      : super(key: key);
              ...
              children: [
                Container(
                    decoration: BoxDecoration(
                        ...
                        border: Border.all(
                            width: 1, color: hexColor(0xFFFFFF, alpha: 0.41))),
                    child: CustomAvatar(
                        uid: widget.data['id'], size: 40)), //需要调整，离线推送也要区分单聊和群聊
                SizedBox(
                  width: 6.w,
                ),
                Padding(
