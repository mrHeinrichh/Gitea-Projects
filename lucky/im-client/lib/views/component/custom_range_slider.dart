...
class _CustomRangeSliderState extends State<CustomRangeSlider> {
  ...
  Widget build(BuildContext context) {
    return EventsWidget(
      data: _data,
      eventTypes: [_CustomDragData.eventDragUpdate],
      builder: (context) {
        return Container(
          width: widget.width,
            ...
            children: [
              Container(
                ...
                child: Container(
                  ...
                  color: widget.inactiveColor ?? colorF2F2F2,
                  alignment: Alignment.centerLeft,
                  child: Container(
                    margin: EdgeInsets.only(left: _data.left),
                    width: _data.right - _data.left,
                    color: widget.activeColor ?? colorE5454D,
                  ),
                ),
              ),
              Positioned(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: widget.cursorColor ?? colorCCCCCC,
