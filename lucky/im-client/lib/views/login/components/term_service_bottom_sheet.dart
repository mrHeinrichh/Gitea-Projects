                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        localized(termServiceMain,params: [Config().appName,Config().appName]),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            padding: const EdgeInsets.only(bottom: 8.0),
                            child: Text(
                              localized(termServiceContent3,params: [Config().appName]),
                              style: jxTextStyle.textStyle12(
                                  color: JXColors.secondaryTextBlack),
                            ),
                          ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            padding: const EdgeInsets.only(bottom: 8.0),
                            child: Text(
                              localized(termServiceContent9,params: [Config().appName]),
                              style: jxTextStyle.textStyle12(
                                  color: JXColors.secondaryTextBlack),
                            ),
                          ),
                    ...
                    Container(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.only(bottom: 8.0),
                        child: Text(
                          localized(termServiceContent11,params: [Config().email]),
                          style: jxTextStyle.textStyle12(
                              color: JXColors.secondaryTextBlack),
                        ),
                      ),
                ...
                Expanded(
                  child: OutlinedButton(
                    style: OutlinedButton.styleFrom(
                      foregroundColor: JXColors.outlineColor,
                      padding: const EdgeInsets.symmetric(vertical: 15),
                      side: const BorderSide(color: JXColors.outlineColor),
