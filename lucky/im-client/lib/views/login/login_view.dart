                  ...
                  child: ListView(
                    ...
                    children: [
                      Obx(
                          ...
                          child: Text(localized(welcomeToHeyTalk,params: [Config().appName]),
                      ...
                      Padding(
                        ...
                        child: Text(localized(loginOrSignUpWith),
                      ...
                      Obx(
                          ...
                          children: [
                            ...
                            Obx(
                                  () => Visibility(
                                visible: notBlank(controller.phoneError.value),
                                child: Padding(
                                  padding:
                          ...
                          children: [
                            ...
                            Obx(
                                  () => Visibility(
                                visible: notBlank(controller.emailError.value),
                                child: Padding(
                                  padding:
                                  const EdgeInsets.only(top: 8, left: 16),
                                  child: Text(
      ...
      child: TextButton(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            color: selectedCondition ? accentColor : JXColors.outlineColor,
          ),
          child: Center(
            child: Text(
              title,
              style: jxTextStyle.textStyleBold14(
                color: selectedCondition
                    ? Colors.white
