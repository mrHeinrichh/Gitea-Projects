...
class AllCallLog extends StatelessWidget {
  const AllCallLog({Key? key}) : super(key: key);
                ...
                : NotificationListener<ScrollNotification>(
                    ...
                    child: SlidableAutoCloseBehavior(
                      child: ListView.builder(
                        ...
                        itemCount: controller.recentCallList.length,
                        itemBuilder: (context, index) {
                          final Call callItem =
                              controller.recentCallList[index];
                          return CallLogTile(
                            key: ValueKey(callItem.channelId),
                            callItem: callItem,
                            isLastIndex:
                                index == controller.recentCallList.length - 1,
                          );
                        },
                      ),
                    ),
