  ...
  Future<void> test() async {
    ...
    try {
      ...
      for (int i = 0; i < md5Results.length; i++) {
        ...
        print('TestPageController Part ${i + 1} MD5 hash: $base64Md5');
      }
      ...
      // 这个是源文件id md5
      print('TestPageController Multipart ETag: $finalMd5-${partMd5s.length}');

      // final fileMd5 = calculateMD5(file.readAsBytesSync());
      // print('TestPageController Multipart fileMd5: $fileMd5');
    } catch (e) {
      print('TestPageController Failed to process file: $e');
    }
  }
