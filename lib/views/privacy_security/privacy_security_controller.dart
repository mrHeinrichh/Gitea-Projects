...
class PrivacySecurityController extends GetxController {
  ...
  Future<void> initPrivacySetting() async {
    ...
    privacyEmailAddress.value =
        Privacy.fromIndex((privacyTypeSetting[showEmailAddress]));
  ...
  Future<void> navigateToEncryptionSetupPage() async {
    EncryptionSetupPasswordType type = await objectMgr.encryptionMgr.isEncryptionNewSetup();
    switch (type) {
