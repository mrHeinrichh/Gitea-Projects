...
class DataProvider {
  ...
  DataProvider({this.uid = 0, this.isGroup = false, this.user, this.group, this.chat}){
    assert(user != null || (group != null && isGroup) || uid > 0, "One of the user, group and uid parameters must be have");
