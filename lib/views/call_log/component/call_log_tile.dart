...
class CallLogTileState extends State<CallLogTile>
  ...
  String getCallLogImage(Call callItem) {
    String imageName = callItem.isVideoCall == 1 ? "icon_video_call" : "icon_call";
    String callerReceiver = objectMgr.userMgr.isMe(callItem.callerId) ? "_caller" : "_receiver";
  ...
  String getDescription() {
    switch (CallEvent.values[widget.callItem.status]) {
      ...
      return (widget.callItem.isVideoCall == 1
          ...
          : localized(attachmentCallVoice)) + " ("+ (constructTimeDetail(widget.callItem.duration)) + ")";
      default:
