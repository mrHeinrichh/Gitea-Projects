...
class AgoraCallView extends GetView<AgoraCallController> {
  ...
  Widget onCallAction(BuildContext context, CallState curCallState) {
    pdebug("onCallAction======> $curCallState, ${objectMgr.callMgr.selfCameraOn.value}, ${objectMgr.callMgr.isInviter}");
          ...
          children: [
            ...
            Column(
              children: [
                GestureDetector(
                  onTap: () async {
                    objectMgr.callMgr.isSpeaker.value = !objectMgr.callMgr.isSpeaker.value;
                    objectMgr.callMgr.setAudioSound(objectMgr.callMgr.isSpeaker.value ? SoundType.speaker : SoundType.reciever);
                  },
        ...
        GestureDetector(
          ...
          child: Column(
            children: [
              ...
              Text(localized(cancel), style: const TextStyle(fontSize: 12))
            ],
          ),
        ),
        GestureDetector(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 8),
              Text(localized(retryCall), style: const TextStyle(fontSize: 12))
            ],
          ),
        ),
      ],
