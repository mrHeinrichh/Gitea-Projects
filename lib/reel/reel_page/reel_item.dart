...
class _ReelItemState extends State<ReelItem>
  ...
  _onVideoUpdates(TencentVideoStream item) {
    ...
    if (widget.index == 0) widget.controller.isLoading.value = false; //流接收到第一片数据的信息，才可做为下载完毕
          ...
          children: <Widget>[
            ...
            AnimatedPositioned(
              ...
              right: (widget.controller.tempReelCommentController.value != null)
                  ? _commentHorizontalAdjustments.value
                  : -_horizontalAdjustments.value,
              bottom: (widget.controller.tempReelCommentController.value !=
                  null)
                  ? _commentVerticalAdjustments.value
                  : -_verticalAdjustments,
              child: Container(
                width: (widget.controller.tempReelCommentController.value !=
                    null)
              ...
              child: GestureDetector(
                ...
                onHorizontalDragUpdate: (details) {
                  if (details.delta.dx > 5) {
                    ...
                    // 向左滑動
                    if (widget.controller.currentTab.value ==
                        ReelController.RECOMMEND_TAB) {
                      widget.controller.onNavigation();

                      if (objectMgr.userMgr.isMe(widget.post.creator.value!.id.value!)) {
            ...
            Positioned.fill(
              ...
              child: Column(
                ...
                children: <Widget>[
                  const Spacer(),
                  Opacity(
                    opacity: widget.controller.isScrolling.value
                        ? 0.5
                        : 1.0,
                    child: Row(
                      children: <Widget>[
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: ReelProfileName(
                                      userId: widget.post.creator.value?.id.value ??
                                          0,
                                      name: widget.post.creator.value?.name.value ??
                                          "",
                                      fontSize: MFontSize.size16.value,
                                    ),
                                  ),
