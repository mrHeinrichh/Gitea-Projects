    ...
    return Scaffold(
      body: Stack(
        children: <Widget>[
                          ...
                          Obx(
                            () => RichText(
                              text: TextSpan(
                                ...
                                children: <TextSpan>[
                                  TextSpan(
                                    text: widget.controller.reelProfile.value.profilePercentage == ''
                                        ? "100%"
                                        : widget.controller.reelProfile.value.profilePercentage,
          ...
          Positioned(
            top:
                (height / 5) - (circleDiameter / 2), // To overlap in the middle
              ...
              children: [
                ...
                Offstage(
                  ...
                  child: ReelProfileAvatar(
                    profileSrc: widget.controller.reelProfile.value.profilePic.value,
        ...
        child: CustomRoundContainer(
          child: ListView(
            ...
            children: [
              ...
              _buildListItem(
                title: localized(bio),
                rightTitle: notBlank(widget.controller.reelProfile.value.bio.value)
