...
class ChatCellContentFactory {
  static Widget createComponent({
    ...
    if (lastMessage.isEncrypted) {
      return _processEncryptedContent(chat,
        lastMessage,
        messageSendState,
      );
    }
    ...
    switch (lastMessage.typ) {
      ...
      case messageTypeEncryptionSettingChange:
        return _processGroupEncryptionSettingChangeContent(chat, lastMessage, messageSendState);
  ...
  static Widget _processMediaContent(
    ...
    switch (lastMessage.typ) {
      case messageTypeImage:
        ...
        caption =
            bean.caption.isNotEmpty ? bean.caption : localized(chatTagPhoto);
        urlList.add({
          'url': bean.url,
      ...
      case messageTypeReel:
        ...
        urlList.add({
          ...
          'isVideo': bean.coverPath.isNotEmpty,
        });
        hasForward = bean.forward_user_id != 0;
        break;
      case messageTypeNewAlbum:
    ...
    return RichText(
      text: TextSpan(
        ...
        children: <InlineSpan>[
          ...
          TextSpan(text: caption, style: jxTextStyle.chatCellContentStyle()),
        ],
      ),
      maxLines: 1,
  ...
  static String getUserNickName(int? chatId, int? uid) {
    ...
    if (chatId != null) {
      ...
      if (group != null) {
        nickName = objectMgr.userMgr
            .getUserTitle(objectMgr.userMgr.getUserById(uid), groupId: chatId);
      }
    }
    if (nickName == "") {
  ...
  static Widget _processEncryptedContent(
    ...
    String content = localized(messageEncrypted);
