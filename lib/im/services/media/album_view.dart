...
class _AlbumViewState extends State<AlbumView> {
  ...
  void onSelectedAlbumTap(AssetPathEntity pathEntity) async {
        ...
        children: <Widget>[
          Expanded(
            child: ListView.builder(
              ...
              itemCount: assetPickerProvider?.pathsList.keys.length,
              itemBuilder: (BuildContext context, int index) {
                final AssetPathEntity pathEntity =
                    assetPickerProvider!.pathsList.keys.elementAt(index);
                final Uint8List? data =
                    assetPickerProvider?.pathsList.values.elementAt(index);
                  ...
                  children: <Widget>[
                    ...
                    GestureDetector(
                      ...
                      onTap: () => Get.back(
                        result: {
                          'caption':
                              showCaption ? inputController.text.trim() : null,
                          'shouldSend': true,
                        },
                      ),
                      child: OpacityEffect(
