...
class _GroupSystemItemState extends State<GroupSystemItem>
  ...
  String getEncryptionSettingChange(Message message) {
    final MessageSystem systemMsg = message.decodeContent(cl: MessageSystem.creator);
    String content = localized(systemMsg.isEnabledEncryption ? chatTurnOnEncryption : chatTurnOffEncryption);
    return content;
  }
