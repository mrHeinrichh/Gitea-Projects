...
class GroupEncryptedSenderItemState extends State<GroupEncryptedSenderItem>
  ...
  Widget buildTextContent(
    ...
    return Column(
      ...
      children: [
        SizedBox(
          height: getTop(isLastMessage, bean, encryptedText),
        ),
  ...
  double getTop(bool isLastMessage, NewLineBean bean, String text) {
    /// 无用户名
    bool k1 = showNickName && !EmojiParser.hasOnlyEmojis(encryptedText);
