...
void main() {
  ...
  PermissionItem label1 = PermissionItem(MomentVisibility.label);
  PermissionItem label2 = PermissionItem(MomentVisibility.label);
...
class PermissionSelection extends PermissionSelectionComposite {
  ...
  void addPermissionSelectionComponent(
    PermissionSelectionComposite permissionSelectionComponent,
  ) {
