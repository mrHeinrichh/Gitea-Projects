...
class ImageMgr {
  ...
  Future<String> resizeImageTo384(String inputPath,String md5Path) async {
    ...
    // Resize the image
    final resizedImage =img.copyResize(image, width: Config().sMessageMin, maintainAspect: true);
    ...
    String path_384 = "${downloadMgr.appDocumentRootPath}/${pathWithoutExtension}_${Config().sMessageMin}$fileExtension";
