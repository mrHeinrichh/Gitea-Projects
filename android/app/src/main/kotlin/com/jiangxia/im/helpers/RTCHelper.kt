...
//            }
        ...
        override fun onFirstRemoteAudioDecoded(uid: Int, elapsed: Int) {
            ...
            Log.v("MainActivity", "onFirstRemoteAudioDecoded=====> $uid")
        ...
        override fun onRemoteVideoStateChanged(uid: Int, state: Int, reason: Int, elapsed: Int) {
            ...
            Log.v("onRemoteVideoStateChanged", "state=====> $uid, $state, $reason")
            if(uid == remoteUid){
                if(state == 3 && reason == 12){ // 对方iOS切后台
                    remoteCameraIsFreezed = true
                }else if(state == 1 && reason == 6){ // 对方iOS从后台切换回前台
                    if(remoteCameraIsFreezed){
...
//        }
    ...
    fun updateVideoStream(sender: String){
        Log.v("updateVideoStream", "=========> $sender, $floatWindowIsMe, $meCameraIsOn, $remoteCameraIsOn, ${this.isMinimized}, ${nativeView?.surfaceView?.width}, ${floatNativeView?.surfaceView?.width}")
