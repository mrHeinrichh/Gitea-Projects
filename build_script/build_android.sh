...
if [ $buildType == "profile" ]; then
	sed -i '' 's|^storeFile=.*|storeFile=/Users/jiangxia/Desktop/profile/im-client/android/upload-keystore.jks|' ../android/key.properties
	...
	sed -i '' 's|^storeFile=.*|storeFile=/Users/jiangxia/Desktop/release/im-client/android/upload-keystore.jks|' ../android/key.properties
