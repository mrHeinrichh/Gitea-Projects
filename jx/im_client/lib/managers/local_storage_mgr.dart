...
class LocalStorageMgr extends EventDispatcher {
  ...
  static const String LAST_STICKERS_AND_GIFS_FETCH =
      "LAST_STICKERS_AND_GIFS_FETCH"; //最爱贴纸
  static const String STICKERS_AND_GIFS_FETCHED =
      "STICKERS_AND_GIFS_FETCHED"; //最爱贴纸
  ...
  /// 版本更新
  static const String APP_VERSION_DETAIL = "APP_VERSION_DETAIL"; //版本号资料
  static const String CURRENT_APP_VERSION = "CURRENT_APP_VERSION"; //现在版本号
  static const String CLOSE_APP_VERSION = "CLOSE_APP_VERSION"; //关闭提示版本号
  ...
  static const String SERVER_URI_CONFIG_KEY = 'SERVER_URI_CONFIG_KEY';
  ...
  static const String APP_STORES_FETCH_TIME = 'APP_STORES_FETCH_TIME';
  ...
  // 最后跟后端获取call log 记录的时间
  static const String LAST_APP_CALL_LOG = 'LAST_APP_CALL_LOG';
  // 记录上一次app启动后获取call log的时间
  static const String LAST_APP_INIT_CALL_LOG = 'LAST_APP_INIT_CALL_LOG';
  static const String LAST_APP_INIT_FRIEND_LIST = 'LAST_APP_INIT_FRIEND_LIST';
  ...
  static const String MOMENT_COVER_SIZE = "MOMENT_COVER_SIZE";
  static const String MOMENT_RECORD = "MOMENT_RECORD";
  static const String MOMENT_NOTIFICATION_CACHE = "MOMENT_NOTIFICATION_CACHE";

  static const String CONTACT_LAST_UPDATE_TIME = "CONTACT_LAST_UPDATE_TIME";
  ...
  static const String SKIP_RECOVER_KEY = "SKIP_RECOVER_KEY";
  static const String HAS_ENCRYPTED_CHATS = "HAS_ENCRYPTED_CHATS";
  static const String SKIP_BACKUP_KEY = "SKIP_BACKUP_KEY";
  static const String PRIVATE_KEY_EXPIRED_KEY = "PRIVATE_KEY_EXPIRED_KEY";
  static const String PK_QR_CODE_DOWNLOADED_KEY = "PK_QR_CODE_DOWNLOADED_KEY";
  static const String BE_ENCRYPTED_KEY = "BE_ENCRYPTED_KEY";
  static const String BE_ENCRYPTION_ENABLED = "BE_ENCRYPTION_ENABLED";
  static const String ANDROID_CHAT_LIST_KEY = "ANDROID_CHAT_LIST_KEY";
  static const String RECENT_MINI_APP_SEARCH_KEYWORDS = "RECENT_MINI_APP_SEARCH_KEYWORDS";
  ...
  Future<bool> write<T>(String key, T value) async {
    if (key == ALL_STICKERS ||
        ...
        key == SERVER_URI_CONFIG_KEY ||
        key == BE_ENCRYPTION_ENABLED ||
        key == ANDROID_CHAT_LIST_KEY) {
