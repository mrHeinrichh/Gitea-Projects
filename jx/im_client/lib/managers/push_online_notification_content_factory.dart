...
class NotificationCellContentFactory {
                  ...
                  child: Row(
                    ...
                    children: [
                      RemoteImage(
                        ...
                        fit: BoxFit.cover,
                        mini: lastMessage.typ == messageTypeFace ||
                                lastMessage.typ == messageTypeGif
                            ? null
                            : Config().headMin,
                      ),
                    ],
  ...
  static String _processTextMessage(Message lastMessage) {
    if (lastMessage.ref_typ != 0) {
      return localized(lastMessageEncryptedNotification);
    }
    switch (lastMessage.typ) {
      ...
      case messageTypeLink:
        ...
        MessageText textData = lastMessage.decodeContent(
            cl: lastMessage.getMessageModel(lastMessage.typ));
