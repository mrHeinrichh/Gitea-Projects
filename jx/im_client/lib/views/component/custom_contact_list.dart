      ...
      () => NotificationListener<ScrollNotification>(
        ...
        child: AzListView(
          ...
          indexBarOptions: IndexBarOptions(
            textStyle: jxTextStyle.supportSmallText(color: themeColor),
            selectTextStyle:
                jxTextStyle.supportSmallText(color: colorTextSecondary),
          ),
        ),
      ),
    );
    ...
    return Column(
      children: <Widget>[
        ...
        ContactCard(
          ...
          user: item.user,
          subTitle: item.user.deletedAt > 0
              ? ''
                  ...
                  GestureDetector(
                    onTap: () {
                      if (item.user.deletedAt > 0) {
                        ...
                        contactController.showCallOptionPopup(
                          context,
                          item.user,
                        );
                      }
