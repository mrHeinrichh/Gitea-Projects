...
import 'package:jxim_client/views/component/floating/assist/floating_data.dart';
import 'package:jxim_client/views/component/floating/assist/floating_slide_type.dart';
import 'package:jxim_client/views/component/floating/listener/floating_listener.dart';
  ...
  void initState() {
    ...
    _fullScreenController.addListener(() {
      if (widget.isPosCache) {
        ...
        _controlBarWidth.value = lerpDouble(
          widget.floatingData.width,
          _parentWidth,
