...
class AuthMethodController extends GetxController {
  ...
  AuthMethodController.desktop(
    phoneNumAuthSwitch,
    emailAuthSwitch,
    emailAuthEmail,
    phoneAuthContact,
    phoneAuthCountryCode,
  ) {
    this.phoneNumAuthSwitch.value = phoneNumAuthSwitch == 1;
    this.emailAuthSwitch.value = emailAuthSwitch == 1;
    this.emailAuthEmail.value = emailAuthEmail;
    this.phoneAuthContact.value = phoneAuthContact;
    this.phoneAuthCountryCode.value = phoneAuthCountryCode;
  }
