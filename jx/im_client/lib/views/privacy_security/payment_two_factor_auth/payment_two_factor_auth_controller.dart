...
class PaymentTwoFactorAuthController extends GetxController {
  ...
  PaymentTwoFactorAuthController();

  PaymentTwoFactorAuthController.desktop(bool paymentTwoFactorAuthSwitch){
    this.paymentTwoFactorAuthSwitch.value = paymentTwoFactorAuthSwitch;
  }
  ...
  onInit() {
    ...
    if (Get.arguments != null) {
      paymentTwoFactorAuthSwitch.value =
          Get.arguments['isPayTwoFactorAuthEnable'] ?? false;
    }
  }
