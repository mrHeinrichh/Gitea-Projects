    ...
    return Positioned.fill(
      child: GetBuilder(
        ...
        builder: (_) {
          return CustomPaint(
            painter:
                controller.scanQrCodeType == ScanQrCodeType.verifyPrivateKey
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Text(
                          ...
                          didGetText == null
                              ? getBrief()
                              : localized(walletQrScanToGetPayAddress),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        Obx(
                          () => Visibility(
                            visible: controller.showBottomButton.value,
                            child: Row(
                              ...
                              children: <Widget>[
                                ...
                                if (isWalletEnable())
                                  qrButton(
                                    ...
                                    onTap: () =>
                                        controller.qrMoneyCodePopUp(context),
                                  ),
                                qrButton(
                                  svgName: 'album',
