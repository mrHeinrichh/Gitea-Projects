                              ...
                              rightWidget: Obx(
                                () => controller.notificationLastInfo.value !=
                                    ...
                                    ? Stack(
                                        ...
                                        children: [
                                          CustomAvatar.normal(
                                            key:ValueKey("${controller.notificationLastInfo
                                                .value!.postCreatorId!}_notification"),
                          ...
                          children: <Widget>[
                            ...
                            if (controller.showReel.value ||
                              ...
                              SettingItem(
                                ...
                                withBorder:objectMgr.miniAppMgr.miniApps.isNotEmpty? true:false,
                              ),

                            Obx(
                              () => ListView.builder(
                                physics: const NeverScrollableScrollPhysics(),
                                itemCount: objectMgr.miniAppMgr.miniApps.length,
                                shrinkWrap: true,
                                itemBuilder: (BuildContext context, int index) {
                                  return SettingItem(
                                    onTap: () =>
                                        controller.onDiscoverMiniAppOptionTap(
                                            context,
                                            objectMgr.miniAppMgr.miniApps[index]),
                                    imgWidget: ClipRRect(
                                      borderRadius: BorderRadius.circular(4.0),
                                      child: RemoteImage(
                                        src: objectMgr.miniAppMgr.miniApps[index].icon ?? '',
                                        height: 28.0,
                                        width: 28.0,
                                        fit: BoxFit.cover,
                                      ),
                                    ...
                                    title:
                                    objectMgr.miniAppMgr.miniApps[index].name ?? '',
                                    withBorder: (index !=
                                        objectMgr.miniAppMgr.miniApps.length - 1)
                                        ? true
                                        : false,
                                  );
                                },
