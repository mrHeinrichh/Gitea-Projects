...
class DateTimeController extends GetxController {
  ...
  void onInit() {
    ...
    if (objectMgr.localStorageMgr.read(LocalStorageMgr.TIME_FORMAT) == null) {
      ...
      timeFormat.value =
          objectMgr.localStorageMgr.read(LocalStorageMgr.TIME_FORMAT);
    }
    ...
    if (objectMgr.localStorageMgr.read(LocalStorageMgr.DATE_FORMAT) == null) {
      ...
      dateFormat.value =
          objectMgr.localStorageMgr.read(LocalStorageMgr.DATE_FORMAT);
    }
  ...
  changeFormat({int? type}) {
    if (type == timeType) {
      objectMgr.localStorageMgr
          .write(LocalStorageMgr.TIME_FORMAT, timeFormat.value);
    } else if (type == dateType) {
      objectMgr.localStorageMgr
          .write(LocalStorageMgr.DATE_FORMAT, dateFormat.value);
    } else {
      objectMgr.localStorageMgr
          .write(LocalStorageMgr.TIME_FORMAT, timeFormat.value);
      objectMgr.localStorageMgr
      ...
      imBottomToast(navigatorKey.currentContext!,
          title: localized(dateAndTimeFormatUpdated),
