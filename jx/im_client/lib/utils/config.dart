...
class Config {
  ...
  String get kiwiTest =>
      const String.fromEnvironment("KIWI_TEST", defaultValue: "");
  ...
  String get sentryCdn => "http://$sentryKey@$sentryUrl/$sentryChannel";

  String get sentryChannel =>
      const String.fromEnvironment("SENTRY_CHANNEL", defaultValue: "");

  // String get kiwiSentry => const String.fromEnvironment("KIWI_SENTRY", defaultValue: "");
  ...
  // 上传加密开关
  bool get is_upload_encrypt =>
      const bool.fromEnvironment("ENABLE_UPLOAD_ENCRYPT", defaultValue: false);

  String get _assert_string =>
      const String.fromEnvironment("ASSERT_LIST", defaultValue: "");
  List<String>? _assert_list;

  List<String> get assert_list => _assert_list ??= _assert_string.split(',');
  ...
  bool get e2eEncryptionEnabled =>
      const bool.fromEnvironment("E2E_ENCRYPTION_ENABLED", defaultValue: false);

  bool get enableChatCategory =>
      const bool.fromEnvironment("ENABLE_CHAT_CATEGORY", defaultValue: false);

  bool get enableUploadLog =>
      const bool.fromEnvironment("ENABLE_UPLOAD_LOG", defaultValue: false);

  String get ipInfoToken =>
      const String.fromEnvironment("IP_INFO_TOKEN", defaultValue: "");

  String get apiHost =>
      const String.fromEnvironment("HOST_API", defaultValue: "");

  String get opHost =>
      const String.fromEnvironment("HOST_OP", defaultValue: "");

  String get uploadHost =>
      const String.fromEnvironment("HOST_UPLOAD", defaultValue: "");

  String get download2Host =>
      const String.fromEnvironment("HOST_DOWNLOAD_2", defaultValue: "");

  String get download1Host =>
      const String.fromEnvironment("HOST_DOWNLOAD_1", defaultValue: "");

  String get speedHost =>
      const String.fromEnvironment("HOST_SPEED_1", defaultValue: "");
}
