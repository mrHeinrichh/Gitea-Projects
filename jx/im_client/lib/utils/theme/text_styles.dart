...
class MFontSize {
  ...
  static MFontSize size11 = Platform.isAndroid
      ? MFontSize(10)
      : objectMgr.loginMgr.isDesktop
          ? MFontSize(10)
          : MFontSize(11);
  static MFontSize size12 = Platform.isAndroid
      ? MFontSize(11)
      : objectMgr.loginMgr.isDesktop
          ? MFontSize(11)
          : MFontSize(12);
  static MFontSize size13 = Platform.isAndroid
      ? MFontSize(12)
      : objectMgr.loginMgr.isDesktop
          ? MFontSize(12)
          : MFontSize(13);
  static MFontSize size14 = Platform.isAndroid
      ? MFontSize(13)
      : objectMgr.loginMgr.isDesktop
          ? MFontSize(13)
          : MFontSize(14);
  static MFontSize size15 = Platform.isAndroid
      ? MFontSize(14)
      : objectMgr.loginMgr.isDesktop
          ? MFontSize(13)
          : MFontSize(15);
  static MFontSize size16 = Platform.isAndroid ? MFontSize(15) : MFontSize(16);
  static MFontSize size17 = Platform.isAndroid
      ? MFontSize(16)
      : objectMgr.loginMgr.isDesktop
          ? MFontSize(14)
          : MFontSize(17);
  static MFontSize size18 = Platform.isAndroid ? MFontSize(17) : MFontSize(18);
  static MFontSize size20 = Platform.isAndroid
      ? MFontSize(19)
      : objectMgr.loginMgr.isDesktop
          ? MFontSize(15)
          : MFontSize(20);
  ...
  static MFontSize size28 = Platform.isAndroid
      ? MFontSize(27)
      : objectMgr.loginMgr.isDesktop
          ? MFontSize(22)
          : MFontSize(28);
  static MFontSize size34 = Platform.isAndroid
      ? MFontSize(33)
      : objectMgr.loginMgr.isDesktop
          ? MFontSize(26)
          : MFontSize(34);
...
class MTextStyle extends TextStyle {
  ...
  TextStyle replyBubbleTextStyle() {
    return normalText(color: colorTextPrimary);
  }
  ...
  TextStyle chatReadBarText() {
    final textStyle = TextStyle(
      fontSize: isDesktop ? 11 : MFontSize.size14.value,
      color: colorTextPrimary,
      decoration: TextDecoration.none,
    );
