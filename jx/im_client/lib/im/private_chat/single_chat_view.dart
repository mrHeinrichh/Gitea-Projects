...
class SingleChatView extends StatelessWidget {
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Obx(() {
                            ...
                            return _buildAvatarInfo(controller.chat);
                          }),
                        ),
                      ],
                    ),
  ...
  Widget _buildTitleView(String title, {bool showEncrypted = false}) {
    return Row(
  ...
  Widget _listUserInfo(Chat chat) {
    ...
    if (chat.isSaveMsg) {
      return _buildTitleView(localized(homeSavedMessage), showEncrypted: true);
    }
