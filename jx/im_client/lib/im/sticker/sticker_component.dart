...
class _StickerComponentState extends State<StickerComponent> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        ...
        if (objectMgr.loginMgr.isDesktop) separateDivider(indent: 0.0),
        Expanded(
          child: Container(
            color: Colors.transparent,
  ...
  Widget stickerHeader() {
    ...
    return Container(
      ...
      height: objectMgr.loginMgr.isDesktop ? 38 : 32,
      child: ListView(
        controller: headerScrollController,
        scrollDirection: Axis.horizontal,
        physics: const ClampingScrollPhysics(),
        padding: EdgeInsets.symmetric(horizontal: objectMgr.loginMgr.isDesktop ? 6 : 12),
        children: [
          OpacityEffect(
            child: GestureDetector(
              ...
              child: tabIcon(objectMgr.loginMgr.isDesktop ? 'add_sticker' : 'shop'),
            ),
          ),
              ...
              return GestureDetector(
                ...
                child: ValueListenableBuilder(
                  ...
                  builder: (_, value, __) {
                    return Container(
                      height: objectMgr.loginMgr.isDesktop ? 38 : 32,
                      width: objectMgr.loginMgr.isDesktop ? 38 : 32,
                      ...
                      padding: EdgeInsets.all(objectMgr.loginMgr.isDesktop ? 5 : 2),
  ...
  Widget stickerContent() {
    return Obx(() {
      if (objectMgr.stickerMgr.isFetched.value == false && stickerCount == 0) {
        return Center(
          child: ElevatedButton(
            onPressed: () {
              objectMgr.stickerMgr.fetch(isForce: true);
            },
            child: const Text('再次重试'),
          ),
        );
      } else {
      ...
      children: <Widget>[
        Text(
          ...
          style: jxTextStyle.supportText(
              fontWeight: MFontWeight.bold5.value, color: colorTextSecondary),
