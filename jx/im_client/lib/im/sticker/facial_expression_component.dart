...
class _FacialExpressionComponentState extends State<FacialExpressionComponent>
  ...
  void initState() {
    ...
    tabController.addListener(onTapControllerListener);

    _pageController.addListener(onPageControllerListener);
  }
  ...
  void dispose() {
    ...
    timer?.cancel();
    tabController.removeListener(onTapControllerListener);

    _pageController.removeListener(onPageControllerListener);
    tabController.dispose();
    _pageController.dispose();
    super.dispose();
  }

  void onTapControllerListener() {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(
          ...
          borderRadius:
              BorderRadius.circular((objectMgr.loginMgr.isDesktop) ? 10 : 0)),
              ...
              children: [
                Container(
                  ...
                  child: TabBar(
                    ...
                    labelStyle: jxTextStyle.headerSmallText(
                      fontWeight: MFontWeight.bold5.value,
                    ),
                    unselectedLabelStyle: jxTextStyle.headerSmallText(
                      fontWeight: MFontWeight.bold5.value,
                    ),
                        ...
                        Toast.showBottomSheet(
                            ...
                            container: Container(
                              padding: objectMgr.loginMgr.isDesktop
                                  ...
                                  : null,
                              child: const ManageStickers(),
                            ));
                      },
                    ),
                  ),
                if (value == FacialExpression.emoji.index &&
