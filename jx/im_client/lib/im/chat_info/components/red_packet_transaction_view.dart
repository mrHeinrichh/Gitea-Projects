...
class _RedPacketTransactionViewState
    extends MessageWidgetMixin<RedPacketTransactionView>
            ...
            child: Row(
              ...
              children: [
                Padding(
                  ...
                  child: SvgPicture.asset(
                    getRedPacketIcon(msgRed.rpType),
                    width: 40,
                    height: 40,
                    fit: BoxFit.fill,
                  ),
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      NicknameText(
                        ...
                        groupId:
                            widget.chat.isGroup ? widget.chat.chat_id : null,
                      ),
                      Padding(
  ...
  String getRedPacketIcon(RedPacketType type) {
    if (type == RedPacketType.normalRedPacket) {
      return 'assets/svgs/normal_red.svg';
    } else if (type == RedPacketType.luckyRedPacket) {
      return 'assets/svgs/luck_red.svg';
    } else {
      return 'assets/svgs/specific_red.svg';
    }
  }
}
