      ...
      showModalBottomSheet(
        ...
        (asset) async {
          if (commonAlbumController
            ...
            await processImage(commonAlbumController
                .assetPickerProvider!.selectedAssets.first);
