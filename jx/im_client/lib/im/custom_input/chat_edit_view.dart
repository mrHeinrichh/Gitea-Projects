        ...
        children: <Widget>[
          Padding(
            ...
            child: SvgPicture.asset(
              ...
              width: objectMgr.loginMgr.isDesktop ? 18.61 : 24,
              height: objectMgr.loginMgr.isDesktop ? 18.61 : 24,
              color: themeColor,
            ),
          ),
          Expanded(
  ...
  Widget buildMsgThumbnail(BuildContext context) {
    ...
    switch (msg.typ) {
      ...
      case messageTypeLink:
        final MessageLink msgContent =
            msg.decodeContent(cl: MessageLink.creator);
        if (msgContent.linkImageSrc.isNotEmpty) {
          child = RemoteImage(
            src: msgContent.linkImageSrc,
            width: 36.0,
            height: 36.0,
            fit: BoxFit.cover,
            mini: Config().messageMin,
