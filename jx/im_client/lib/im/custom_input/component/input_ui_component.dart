...
abstract class InputUIComponent extends GetView<CustomInputController> {
  ...
  popDesktopSticker(BuildContext context, CustomInputController controller) {
    ...
    desktopGeneralDialog(context,
        ...
        widgetChild: Stack(
          children: [
            //讓user不受彈窗barrier限制,可直接點擊按鈕區塊發送emoji
            //如果按鈕位置UI變更,也需調整觸發位置
            Positioned(
              right: 19,
              bottom: 0,
                    ...
                    children: [
                      FacialExpressionComponent(
                        ...
                        onDeleteLastOne: () {
                          ...
                          final newText =
                              originalText.characters.skipLast(1).string;
      ...
      child: GestureDetector(
        ...
        child: Container(
          margin: objectMgr.loginMgr.isDesktop
              ? const EdgeInsets.only(bottom: 7, left: 20)
              : null,
      ...
      () => AnimatedCrossFade(
                    ...
                    ? OpacityEffect(
                        child: Padding(
                          padding: EdgeInsets.only(
                            left: objectMgr.loginMgr.isDesktop ? 1 : 10.0,
                            right: objectMgr.loginMgr.isDesktop ? 23 : 10.0,
                            bottom: objectMgr.loginMgr.isDesktop ? 14 : 12,
                            top: objectMgr.loginMgr.isDesktop ? 9 : 12,
                          ),
                          child: SvgPicture.asset(
                            'assets/svgs/input_keyboard.svg',
                            width: objectMgr.loginMgr.isDesktop ? 26 : 32,
                            height: objectMgr.loginMgr.isDesktop ? 26 : 32,
                          ),
                        ),
                      )
                    : objectMgr.loginMgr.isDesktop
                        ...
                        : OpacityEffect(
                            child: Padding(
                              padding: EdgeInsets.only(
                                left: objectMgr.loginMgr.isDesktop ? 1 : 10.0,
                                right: objectMgr.loginMgr.isDesktop ? 25 : 10.0,
                                bottom: 12,
                                top: 12,
                              ),
                              child: SvgPicture.asset(
        ...
        secondChild: Obx(() {
          return GestureDetector(
            ...
            child: Padding(
              padding: EdgeInsets.only(
                left: objectMgr.loginMgr.isDesktop ? 0 : 10.0,
                right: objectMgr.loginMgr.isDesktop ? 20 : 10.0,
                bottom: objectMgr.loginMgr.isDesktop ? 9 : 12,
                top: objectMgr.loginMgr.isDesktop ? 9 : 12,
              ),
              child: ClipOval(
                child: Container(
  ...
  Widget buildInput(BuildContext context) {
    return Container(
      ...
      margin: EdgeInsets.symmetric(
          vertical: objectMgr.loginMgr.isDesktop ? 7 : 8.0),
      padding: EdgeInsets.only(
          top: objectMgr.loginMgr.isDesktop ? 1 : 0.0,
          bottom: objectMgr.loginMgr.isDesktop ? 1 : 0.0,
          right: objectMgr.loginMgr.isDesktop ? 8 : 0.0),
  ...
  Widget buildTextFormField(BuildContext context) {
    return TextFormField(
      ...
      contextMenuBuilder: textMenuBarForClipBoard,
      //textMenuBar,
      onTap: () async {
    ...
    return CustomizeAdaptiveTextSelectionToolbar.buttonItems(
      ...
      buttonItems: [
        if (Platform.isIOS &&
            ...
            !buttonItems
                .any((element) => element.type == ContextMenuButtonType.paste))
        ...
        child: (controller.sendState.value ||
            ...
            : GestureDetector(
                ...
                child: Padding(
                  padding: EdgeInsets.only(
                    left: 2.0,
                    bottom: objectMgr.loginMgr.isDesktop ? 3.5 : 0,
                  ),
                  child: Text(
                ...
                Padding(
                  ...
                  child: ForegroundOverlayEffect(
                    ...
                    child: Container(
                      ...
                      //     right: objectMgr.loginMgr.isDesktop ? 10 : 0),
                      height: 36,
                      alignment: Alignment.center,
                      ...
                      child: Text(
                        controller.isLongPressVoiceRecordBtn.value
                            ? localized(releaseToEnd)
