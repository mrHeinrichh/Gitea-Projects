...
class _ChatPopAnimationState extends State<ChatPopAnimation>
  ...
  void initState() {
    ...
    objectMgr.stickerMgr
        .on(StickerMgr.keyChatPopMenuCloseEvent, _onChatPopMenuCloseEvent);

    _animationController = AnimationController(
      duration: kAniDuration,
      reverseDuration: kAniDuration,
      vsync: this,
    );
  ...
  void _onChatPopMenuCloseEvent(Object sender, Object type, Object? data) {
    bool popupEnabled = data as bool;
    canScroller = false;
    handleAnimationController(popupEnabled);
  }

  void handleAnimationController(bool status) {
    if (status) {
  ...
  void dispose() {
    ...
    objectMgr.stickerMgr
        .off(StickerMgr.keyChatPopMenuCloseEvent, _onChatPopMenuCloseEvent);
  ...
  void didUpdateWidget(ChatPopAnimation oldWidget) {
    ...
    if (widget.isShow != oldWidget.isShow) {
      handleAnimationController(widget.isShow);
    }
  }
