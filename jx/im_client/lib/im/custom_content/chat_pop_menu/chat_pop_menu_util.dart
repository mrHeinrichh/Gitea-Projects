...
class ChatPopMenuConfig {
  ...
  static List<List<String>> get menuConfigMiniApp {
    return [
      [
        MessagePopupOption.forward.optionType,
        MessagePopupOption.delete.optionType,
  ...
  /// 1.文件（桌面版）
  static List<List<String>> get menuConfigFile {
    return [
      [
        MessagePopupOption.reply.optionType,
        MessagePopupOption.pin.optionType,
        MessagePopupOption.unPin.optionType,
        MessagePopupOption.saveToDownload.optionType,
        MessagePopupOption.forward.optionType,
        MessagePopupOption.delete.optionType,
      ],
      [
  ...
  /// sticker
  /// gif
  static List<List<String>> get menuConfigSticker {
    return [
      [
        MessagePopupOption.reply.optionType,
        MessagePopupOption.pin.optionType,
  ...
  /// 联络人
  static List<List<String>> get menuConfigRecommendFriend {
    return [
      [
        MessagePopupOption.reply.optionType,
        MessagePopupOption.pin.optionType,
      ...
      switch (message.typ) {
        ...
        case messageTypeFile:
          if (objectMgr.loginMgr.isDesktop) {
            menuConfigList = ChatPopMenuConfig.menuConfigFile;
          } else {
            menuConfigList = ChatPopMenuConfig.menuConfigNewAlbum;
          }
        case messageTypeFace:
        case messageTypeGif:
          menuConfigList = ChatPopMenuConfig.menuConfigSticker;
        ...
        case messageTypeRecommendFriend:
          menuConfigList = ChatPopMenuConfig.menuConfigRecommendFriend;
        // case messageTypeNotFriend:
        //   menuConfigList = ChatPopMenuConfig.menuConfigNotFriend;
        case messageTypeShareChat:
          menuConfigList = ChatPopMenuConfig.menuConfigMiniApp;
        default:
      ...
      if (message.isTranslatableType) {
        if (notBlank(message.messageContent)) {
          if (e.optionType == MessagePopupOption.textToVoice.optionType) {
            ...
            // 後面還要判斷 messageTypeText 只有純emoji不顯示朗讀
            // return e;
          }
        }
      }
