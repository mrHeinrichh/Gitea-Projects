...
class TransferMoneySender extends StatefulWidget {
...
class _TransferMoneyMeState extends MessageWidgetMixin<TransferMoneySender> {
  ...
  Widget messageBody(BuildContext context) {
    return Container(
      ...
      padding: EdgeInsets.only(
          left: controller.chatController.chooseMore.value ? 40.w : 0.0),
      child: Obx(
        () => TransferMoneyBubble(
  ...
  Widget build(BuildContext context) {
    final child = messageBody(context);
