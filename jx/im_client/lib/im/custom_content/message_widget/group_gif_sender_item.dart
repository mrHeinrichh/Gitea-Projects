...
class GroupGifSenderItem extends StatefulWidget {
  ...
  @override
  GroupGifSenderItemState createState() => GroupGifSenderItemState();
}

class GroupGifSenderItemState extends MessageWidgetMixin<GroupGifSenderItem> {
  ...
  void initState() {
    super.initState();
    if (widget.messageImage.width == 0 || widget.messageImage.height == 0) {
      adjustGifDimensionByMessageImage(widget.messageImage);
    }
    controller =
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (showReplyContent &&
                      ...
                      ChatBubbleBody(
                        position: BubblePosition.isMiddleMessage,
  ...
  Widget _buildSticker() {
    ...
    final originalWidth = msgImg.width > 0 ? msgImg.width.toDouble() : null;
    final originalHeight = msgImg.height > 0 ? msgImg.height.toDouble() : null;

    double? width = originalWidth;
    double? height = originalHeight;

    final maxWidth = 300.w;
    final maxHeight = 338.w;
    ...
    if (width == null || height == null) {
      width = widget.messageImage.width.toDouble();
      width = width > 0 ? width : maxWidth;
      height = widget.messageImage.height.toDouble();
