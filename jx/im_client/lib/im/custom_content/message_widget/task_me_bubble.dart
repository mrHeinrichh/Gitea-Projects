...
class TaskMeBubbleState extends MessageWidgetMixin<TaskMeBubble> {
        ...
        child: Row(
          ...
          children: [
            Expanded(
              child: Text(
                subTask.content,
                style: const TextStyle(fontSize: 16.0, color: colorTextPrimary),
              ),
            ),
            const SizedBox(width: 8),
            Assignee(uid: subTask.uid, color: colorTextPrimary),
          ],
        ),
      ),
    );
