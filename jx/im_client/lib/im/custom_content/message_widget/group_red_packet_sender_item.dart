...
class _GroupRedPacketSenderItemState
    extends MessageWidgetMixin<GroupRedPacketSenderItem> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget child = messageBody(context, rpConfig);
    ...
    return Obx(() {
      ...
      Widget body = AnimatedContainer(
        ...
        constraints: BoxConstraints(
            maxWidth: objectMgr.loginMgr.isDesktop ? 180 : 240.w,
            minWidth: objectMgr.loginMgr.isDesktop ? 180 : 0),
        child: Stack(
          children: [
            LayoutBuilder(
                  ...
                  () => GestureDetector(
                    onTap: objectMgr.loginMgr.isDesktop
                        ...
                        : controller.chatController.popupEnabled
                            ...
                            : () {
                                if (controller
                                    .chatController.isSetPassword.value) {
                    ...
                    child: Container(
                      ...
                      child: RedPacketMessageBubble(
                        ...
                        redPacketRemark: widget.messageRed.remark,
            ...
            Positioned(
              right: objectMgr.loginMgr.isDesktop ? 8 : 8.w,
  ...
  void openRedPacket(BoxConstraints constraints, RedPacketTheme theme) {
    ...
    if (redPacketStatus.value != 0 && redPacketStatus.value != rpYetReceive) {
      ...
      controller.chatController.redPacketEntry = OverlayEntry(
  ...
  void navigateToLeaderboard({Function? function}) {
    Get.toNamed(
      RouteName.redPacketLeaderboard,
      id: objectMgr.loginMgr.isDesktop ? 1 : null,
      arguments: {
        'redPacketStatus':
            redPacketStatus.value != 0 ? redPacketStatus.value : 6,
