...
class Chat extends $pb.GeneratedMessage {
  factory Chat({
    ...
    if (iconGaussian != null) {
      $result.iconGaussian = iconGaussian;
    }
    return $result;
  }
  Chat._() : super();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Chat', package: const $pb.PackageName(_omitMessageNames ? '' : 'proto'), createEmptyInstance: create)
    ...
    ..aOS(27, _omitFieldNames ? '' : 'icon_gaussian')
  ...
  @$pb.TagNumber(21)
  $core.int get lastTime => $_getIZ(17);
  @$pb.TagNumber(21)
  set lastTime($core.int v) { $_setUnsignedInt32(17, v); }
  @$pb.TagNumber(21)
  $core.bool hasLastTime() => $_has(17);
  @$pb.TagNumber(21)
  void clearLastTime() => clearField(21);

  @$pb.TagNumber(23)
  $core.int get verified => $_getIZ(18);
  @$pb.TagNumber(23)
  set verified($core.int v) { $_setUnsignedInt32(18, v); }
  @$pb.TagNumber(23)
  $core.bool hasVerified() => $_has(18);
  @$pb.TagNumber(23)
  void clearVerified() => clearField(23);

  @$pb.TagNumber(24)
  $core.String get icon => $_getSZ(19);
  @$pb.TagNumber(24)
  set icon($core.String v) { $_setString(19, v); }
  @$pb.TagNumber(24)
  ...
  @$pb.TagNumber(26)
  $core.String get profile => $_getSZ(21);
  @$pb.TagNumber(26)
  set profile($core.String v) { $_setString(21, v); }
  @$pb.TagNumber(26)
  $core.bool hasProfile() => $_has(21);
  @$pb.TagNumber(26)
  void clearProfile() => clearField(26);

  @$pb.TagNumber(27)
  $core.String get iconGaussian => $_getSZ(22);
  @$pb.TagNumber(27)
  set iconGaussian($core.String v) { $_setString(22, v); }
  @$pb.TagNumber(27)
  $core.bool hasIconGaussian() => $_has(22);
  @$pb.TagNumber(27)
  void clearIconGaussian() => clearField(27);
}
...
class ChatMessage extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(19)
  $core.String get cmid => $_getSZ(17);
  @$pb.TagNumber(19)
  set cmid($core.String v) { $_setString(17, v); }
  @$pb.TagNumber(19)
  $core.bool hasCmid() => $_has(17);
  @$pb.TagNumber(19)
  void clearCmid() => clearField(19);
}
...
class GroupMember extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GroupMember', package: const $pb.PackageName(_omitMessageNames ? '' : 'proto'), createEmptyInstance: create)
    ...
    ..a<$core.int>(6, _omitFieldNames ? '' : 'delete_time', $pb.PbFieldType.OU3)
    ..aOS(7, _omitFieldNames ? '' : 'icon_gaussian')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(7)
  $core.String get iconGaussian => $_getSZ(6);
  @$pb.TagNumber(7)
  set iconGaussian($core.String v) { $_setString(6, v); }
  @$pb.TagNumber(7)
  $core.bool hasIconGaussian() => $_has(6);
  @$pb.TagNumber(7)
  void clearIconGaussian() => clearField(7);
}
...
class ChatGroup extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ChatGroup', package: const $pb.PackageName(_omitMessageNames ? '' : 'proto'), createEmptyInstance: create)
    ...
    ..aOS(16, _omitFieldNames ? '' : 'icon_gaussian')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(16)
  $core.String get iconGaussian => $_getSZ(15);
  @$pb.TagNumber(16)
  set iconGaussian($core.String v) { $_setString(15, v); }
  @$pb.TagNumber(16)
  $core.bool hasIconGaussian() => $_has(15);
  @$pb.TagNumber(16)
  void clearIconGaussian() => clearField(16);
}
