...
class _ReelPreviewState extends State<ReelPreview>
  ...
  void initState() {
    ...
    TencentVideoConfig config = TencentVideoConfig(
      ...
      autoplay: videoStreamMgr.currentIndex.value == widget.index,
      isLoop: true,
    );
              ...
              child: Container(
                ...
                child: currentVideoStream.value != null
                    ? TencentVideoPlayer(
                        ...
                        hasStartedPlaying:
                            currentVideoStream.value!.stopRemoval,
                      )
                    : Container(),
              ),
            ),
                                  ...
                                  Get.toNamed(
                                    ...
                                    arguments: {
                                      "onBack": (toDismiss) {
                                        ...
                                        videoStreamMgr
                                            .enteringBusinessPausePhase = false;
