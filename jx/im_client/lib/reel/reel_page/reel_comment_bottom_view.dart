                    ...
                    Expanded(
                      child: Stack(
                        children: [
                          Offstage(
                            offstage:
                                widget.controller.post.value.comments.isEmpty,
                            child: ListView.builder(
                              ...
                              itemCount:
                                  widget.controller.post.value.comments.length,
                              itemBuilder: (context, index) {
                                return ReelCommentTile(
                                    comment: widget
                                        .controller.post.value.comments[index],
                                    onProfileTap: () async {
                                      ...
                                      ReelComment c = widget.controller.post
