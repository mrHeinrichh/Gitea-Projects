...
class TagsFriendBottomSheet extends StatelessWidget {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            /// Contact List
            Obx(
                  () => (controller.azFilterIncludeBlockedList.isNotEmpty)
                  ? Expanded(
                child: AzListView(
                  noResultFound: localized(noResultFound),
                  data: controller.azFilterIncludeBlockedList,
                  itemCount: controller.azFilterIncludeBlockedList.length,
                  itemBuilder: (context, index) {
                    final item = controller.azFilterIncludeBlockedList[index];
                    return _buildListItem(context, item);
                  },
                  showIndexBar: controller.isSearching.value ||
                      controller.searchParam.isNotEmpty,
                  indexBarData: controller.filterIncludeBlockedIndexBar(),
  ...
  Widget _buildListItem(BuildContext context, AZItem item) {
    ...
    final user = controller.userListIncludeBlocked
