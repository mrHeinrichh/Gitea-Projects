                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          GetBuilder(
                            ...
                            id: 'like_view',
                            builder: (_) {
                              return ((momentLikes.count ?? 0) > 0 || (momentCommentDetail.count ?? 0) > 0)
                                  ? Container(
                  ...
                  Obx(
                    () => ClipRect(
                      child: AnimatedAlign(
                        ...
                        heightFactor:
                            !controller.isCommentInputExpand.value ? 0.0 : 1.0,
  ...
  Widget _buildMomentPostContent(BuildContext context) {
    return Container(
      padding: EdgeInsets.only(
        left: 12.0,
        right: 12.0,
        bottom: (momentLikes.count ?? 0) > 0 || (momentCommentDetail.count ?? 0) > 0
                ? 0.0
                : 8.0,
        top: 16.0,
      ),
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: Container(
                      ...
                      constraints: BoxConstraints(
                        maxHeight: linkPreviewData.isBigMedia ? double.infinity : 66.0,
                      ),
            ...
            child: Row(
              children: <Widget>[
                ...
                if (objectMgr.userMgr.isMe(momentPost.userId!) &&
                    notBlank(momentPost.visibility) &&
                    momentPost.visibility! != MomentVisibility.public.value)
                  GestureDetector(
                    onTap: () => controller.onVisibilityTap(
                        context, controller.post.value),
                    child: Padding(
                    ...
                    TextSpan(
                      children: <InlineSpan>[
                        ...
                        TextSpan(
                          ...
                          style:
                              jxTextStyle.textStyle15(color: colorTextPrimary),
                        ),
                      ],
                    ),
                  ),
