...
class SearchFileUI extends StatefulWidget {
  ...
  @override
  State<SearchFileUI> createState() => _SearchFileUIState();
}

class _SearchFileUIState extends State<SearchFileUI>
  ...
  @override
  void didUpdateWidget(covariant SearchFileUI oldWidget) {
  ...
  Future<void> loadMoreSearchMessage() async {
    ...
    int totalCount = await objectMgr.localDB
        .getMessageCount([messageTypeFile], widget.searchText);
