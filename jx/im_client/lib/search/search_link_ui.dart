...
class SearchLinkUI extends StatefulWidget {
  ...
  @override
  State<SearchLinkUI> createState() => _SearchLinkUIState();
}

class _SearchLinkUIState extends State<SearchLinkUI>
  ...
  @override
  void didUpdateWidget(covariant SearchLinkUI oldWidget) {
          ...
          itemBuilder: (context, index) {
            ...
            if (message.id == 0) {
              ...
              return Padding(
                ...
                child: LinkItem(
                  message: message,
                  messageLink: message.decodeContent(cl: MessageLink.creator),
                  onMoreSelected: false,
                  isSearch: true,
                ),
              );
            }
  ...
  Future<void> loadMoreSearchMessage() async {
    ...
    int totalCount = await objectMgr.localDB
        .getMessageCount([messageTypeLink], widget.searchText);
