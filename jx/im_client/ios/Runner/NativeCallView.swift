...
public class NativeCallView: NSObject, FlutterPlatformView {
    ...
    public func view() -> UIView {
        if(uid == agoraCallManager.localUserId){
            ...
            agoraCallManager.fullLocalVideo.avatarUrl = avatarUrl
            ...
            agoraCallManager.fullRemoteVideo.avatarUrl = avatarUrl
...
class SampleBufferDisplayView: UIView {
    ...
    func initAvatarView() -> UIView{
        ...
        if let appDelegate = UIApplication.shared.delegate as? AppDelegate, let callMgr = appDelegate.agoraCallManager {
            ...
            if let avatarURL = getAvatarURL(avatarUrl: avatarUrl) {
    ...
    func getAvatarURL(avatarUrl: String) -> URL? {
        ...
        if let range = avatarUrl.range(of: "/Documents") {
            let startIndex = range.upperBound
            newAvatarUrl = String(avatarUrl[startIndex...])
        } else {
            return URL(string: avatarUrl)
        }
        ...
        let fileURL = documentsDirectory!.appendingPathComponent(newAvatarUrl)
        return fileURL
    }
