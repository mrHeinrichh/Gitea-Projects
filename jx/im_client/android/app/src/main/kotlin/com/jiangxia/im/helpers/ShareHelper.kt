...
class ShareHelper private constructor() {
    ...
    private fun handleSendText(context: Context,intent: Intent) {
        ...
        if(sharedText != null && sharedText.isNotEmpty()){
            ...
            if (bundle != null) {
                // 通过 key "android.intent.extra.STREAM" 获取对应的 Uri 值
                val uri: Uri? = bundle.getParcelable(Intent.EXTRA_STREAM)
                ...
                if (uri != null) {
                    ...
                    Log.e("handleSendText", "File========>No file shared.")
                } else {
                    Log.e("handleSendText", "File========>No file shared.")
                }
            } else {
                Log.e("handleSendText", "File========> No bundle found.")
            }
        }
    }
