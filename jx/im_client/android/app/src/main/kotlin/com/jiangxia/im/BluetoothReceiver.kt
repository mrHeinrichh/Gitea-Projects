...
class BluetoothReceiver : BroadcastReceiver() {
    private var mBluetoothListener: BluetoothListener? = null
    private var cachedDevices: MutableSet<String> = mutableSetOf()
    ...
    fun setInitCachedDevices(devices: List<String>){
        cachedDevices = devices.toMutableSet()
    }
    ...
    override fun onReceive(context: Context?, intent: Intent) {
        ...
        when (action) {
            ...
            BluetoothDevice.ACTION_ACL_DISCONNECT_REQUESTED -> {
                ...
                hasBluetooth = false
                cachedDevices.remove(deviceName)
            }

            else -> {}
        }

        this.mBluetoothListener?.bluetoothChanged(dataMap)
    }

    fun getAvailableBluetooth(): List<String>{
