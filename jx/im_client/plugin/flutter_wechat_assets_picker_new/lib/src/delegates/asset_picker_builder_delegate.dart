...
import 'package:wechat_assets_picker/src/models/path_wrapper.dart';
  ...
  Widget bottomActionBar(BuildContext context) {
    if (isPermissionLimited) {
      return Column(
        ...
        children: <Widget>[
          accessLimitedBottomTip(context),
        ],
      );
    }
    return const SizedBox.shrink();
...
class DefaultAssetPickerBuilderDelegate
  ...
  final void Function(int index, AssetEntity asset)? onAssetTap;
  ...
  @override
  Future<List<AssetEntity>?> selectAsset(
    BuildContext context,
    AssetEntity asset,
    bool selected,
  ) async {
    ...
    if (isSingleAssetMode && !isPreviewEnabled) {
      ...
      return provider.selectedAssets; //prevent pop when single page
    }
    return null;
  }
  ...
  AssetPickerAppBar appBar(BuildContext context) {
    return const AssetPickerAppBar(
      ...
      body: Consumer<DefaultAssetPickerProvider>(
        builder: (BuildContext context, DefaultAssetPickerProvider p, _) {
          final bool shouldDisplayAssets =
              p.sheetOpened && (p.hasAssetsToDisplay || shouldBuildSpecialItem);
          ...
          Positioned.fill(
            child: Consumer<DefaultAssetPickerProvider>(
              builder: (_, DefaultAssetPickerProvider p, __) {
                ...
                if (permission.value == PermissionState.limited) {
                  child = Stack(
                    children: [
                      Padding(
                        padding: EdgeInsets.only(
                            bottom: ((!isSingleAssetMode || isAppleOS) &&
                                    isPreviewEnabled)
                                ? permissionLimitedBarHeight - 20
                                : 0),
                        child: child,
                      ),
  ...
  Widget assetsGridBuilder(BuildContext context) {
    return Selector<DefaultAssetPickerProvider, PathWrapper<AssetPathEntity>?>(
      ...
      builder:
          (BuildContext context, PathWrapper<AssetPathEntity>? wrapper, __) {
              ...
              child: ColoredBox(
                ...
                child: Selector<DefaultAssetPickerProvider, List<AssetEntity>>(
                  selector: (_, DefaultAssetPickerProvider p) =>
                      p.currentAssets,
                  builder: (BuildContext ctx, List<AssetEntity> assets, __) {
                    //final SliverGap bottomGap = SliverGap.v(context.bottomPadding + bottomSectionHeight,);
                    final SliverGap bottomGap =
                        SliverGap.v(context.bottomPadding);
            ...
            child: AnimatedOpacity(
              ...
              child: Container(
                constraints: BoxConstraints(
                  maxHeight: 4 * context.mediaQuery.size.height / 5 - 58,
                ),
    ...
    return Consumer<DefaultAssetPickerProvider>(
      ...
      child: Consumer<DefaultAssetPickerProvider>(
        builder: (_, DefaultAssetPickerProvider p, __) => GestureDetector(
          onTap: p.isSelectedNotEmpty ? myOnTap : null,
  ...
  Widget selectIndicator(BuildContext context, int index, AssetEntity asset) {
    ...
    return Consumer<DefaultAssetPickerProvider>(
      builder: (_, DefaultAssetPickerProvider p, __) {
        final bool selected = p.selectedDescriptions.contains(asset.toString());
        final int selectIndex = p.selectedAssets.indexOf(asset);
  ...
  Widget selectedBackdrop(
    ...
    return Positioned.fill(
      child: GestureDetector(
        onTap: isPreviewEnabled ? () => onAssetTap?.call(index, asset) : null,
        child: Consumer<DefaultAssetPickerProvider>(
          builder: (_, DefaultAssetPickerProvider p, __) {
            return Container(
              decoration: BoxDecoration(
