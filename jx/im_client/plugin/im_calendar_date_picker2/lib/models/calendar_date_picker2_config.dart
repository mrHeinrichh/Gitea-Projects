...
class CalendarDatePicker2WithActionButtonsConfig
  ...
  CalendarDatePicker2WithActionButtonsConfig({
    ...
    super.weekdayLabels,
    super.weekdayLabelTextStyle,
    super.weekdayLabelBuilder,
    super.firstDayOfWeek,
    super.controlsHeight,
    super.lastMonthIcon,
    super.nextMonthIcon,
    super.controlsTextStyle,
    super.animateToDisplayedMonthDate,
    super.dayViewController,
    super.dayTextStyle,
    super.selectedDayTextStyle,
    super.selectedDayHighlightColor,
    super.themeColor,
    super.selectedRangeHighlightColor,
    super.disabledDayTextStyle,
    super.todayTextStyle,
    super.yearTextStyle,
    super.selectedYearTextStyle,
    super.disabledYearTextStyle,
    super.selectedRangeDayTextStyle,
    super.monthTextStyle,
    super.selectedMonthTextStyle,
    super.disabledMonthTextStyle,
    super.dayBorderRadius,
    super.yearBorderRadius,
    super.monthBorderRadius,
    super.selectableDayPredicate,
    super.selectableMonthPredicate,
    super.selectableYearPredicate,
    super.dayTextStylePredicate,
    super.dayBuilder,
    super.yearBuilder,
    super.monthBuilder,
    super.monthViewController,
    super.yearViewController,
    super.disableModePicker,
    super.centerAlignModePicker,
    super.customModePickerIcon,
    super.modePickerTextHandler,
    super.modePickerBuilder,
    super.modePickersGap,
    super.rangeBidirectional,
    super.calendarViewScrollPhysics,
    super.daySplashColor,
    super.allowSameValueSelection,
    super.disableMonthPicker,
    super.useAbbrLabelForMonthModePicker,
    super.dayMaxWidth,
    super.hideMonthPickerDividers,
    super.hideYearPickerDividers,
    super.scrollViewTopHeaderTextStyle,
    super.hideScrollViewTopHeader,
    super.hideScrollViewTopHeaderDivider,
    super.hideScrollViewMonthWeekHeader,
    super.scrollViewConstraints,
    super.scrollViewMonthYearBuilder,
    super.scrollViewOnScrolling,
    super.scrollViewController,
    super.dynamicCalendarRows,
    super.dayModeScrollDirection,
    super.selectedRangeHighlightBuilder,
    super.selectedRangeDecorationPredicate,
