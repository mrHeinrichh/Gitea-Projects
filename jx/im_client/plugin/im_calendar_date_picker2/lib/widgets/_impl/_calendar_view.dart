...
class _CalendarViewState extends State<_CalendarView> {
  ...
  Widget build(BuildContext context) {
    Color controlColor = widget.config.themeColor ?? Colors.grey;
            ...
            child: Row(
              children: <Widget>[
                if (widget.config.centerAlignModePicker != true) const Spacer(),
                 OpacityEffect(
                   isDisabled: _isDisplayingFirstMonth,
                   child: IconButton(
                      splashRadius: 1,
                      icon: widget.config.lastMonthIcon ??
                          Icon(
                            widget.config.dayModeScrollDirection == Axis.vertical
                                ? Icons.keyboard_arrow_up
                                : Icons.keyboard_arrow_left_rounded,
                            color: _isDisplayingFirstMonth
                                ? const Color(0x33121212)
                                : controlColor,
                          ),
              ...
              OpacityEffect(
                isDisabled: _isDisplayingLastMonth,
                child: IconButton(
                      splashRadius: 1,
