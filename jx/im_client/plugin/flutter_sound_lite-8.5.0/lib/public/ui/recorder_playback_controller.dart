...
class RecorderPlaybackController extends InheritedWidget {
  ...
  ///
  RecorderPlaybackController({Key? key, required Widget child})
...
class _RecordPlaybackControllerState {
  ...
  void _registerRecorder(SoundRecorderUIState recorderUIState) {
    ...
    _recorderUIState!.dispositionStream!.listen((recorderDisposition) =>
        _localController.add(PlaybackDisposition(
            position: Duration.zero, duration: recorderDisposition.duration)));
  }
}
