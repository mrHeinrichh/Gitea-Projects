...
// -----------------------------------------------------------------------------------------------------------
  ...
  const SoundPlayerUI.fromLoader(
    OnLoad onLoad, {
    Key? key,
...
class SoundPlayerUIState extends State<SoundPlayerUI> {
  ...
  Future<bool> get canPlay async {
    return _onLoad != null || (_track != null);
  }
  ...
  Widget _buildPlayButton() {
    ...
    if (_loading == true) {
      button = StreamBuilder<PlaybackDisposition>(
            ...
            child: FutureBuilder<bool>(
                ...
                builder: (context, asyncData) {
                  ...
                  if (asyncData.connectionState == ConnectionState.done) {
                    canPlay = asyncData.data! && !__transitioning;
                  }
...
class _GrayedOut extends StatelessWidget {
  ...
  ///
  const _GrayedOut({required this.child, this.grayedOut = true})
...
class PlaybarSlider extends StatefulWidget {
  ...
  ///
  const PlaybarSlider(this.stream, this._seek, this._sliderThemeData,
      {Key? key})
      : super(key: key);
