...
class _NotificationController extends InheritedWidget {
  ...
  Future<void> create({
    ...
    await dismiss(shouldAnimation: !state.showController.isDismissed, activeDismiss: false);
  ...
  Future<void> dismiss({bool shouldAnimation = true, double from = 1.0, bool activeDismiss = true}) async {
    state.timer?.cancel();
