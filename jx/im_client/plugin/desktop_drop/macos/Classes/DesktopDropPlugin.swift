...
class DropTarget: NSView {
  ...
  override func draggingEntered(_ sender: NSDraggingInfo) -> NSDragOperation {
    let urls = getFileUrl(sender, group: group)
    channel.invokeMethod("entered", arguments: convertPoint(sender.draggingLocation, urls))
    return .copy
  }

  override func draggingUpdated(_ sender: NSDraggingInfo) -> NSDragOperation {
    let urls = getFileUrl(sender, group: group)
    channel.invokeMethod("updated", arguments: convertPoint(sender.draggingLocation, urls))
    return .copy
  }
 ...
 func getFileUrl(_ sender: NSDraggingInfo, group: DispatchGroup) -> [String]{
    var urls = [String]()
    ...
    func convertPoint(_ location: NSPoint, _ fileUrls: [String]) -> [Any] {
    return [location.x, bounds.height - location.y, fileUrls]
  }
}
