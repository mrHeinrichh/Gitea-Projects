...
class InViewNotifier extends StatefulWidget {
  ...
  final Function(List<String>)? onEndScroll;
  final VoidCallback? onStartScroll;
  final Function(int)? onViewAdded;
  final Function(int)? onViewRemoved;
...
class _InViewNotifierState extends State<InViewNotifier> {
  ...
  void _initializeInViewState() {
    _inViewState = InViewState(
      ...
      onViewAdded: widget.onViewAdded,
      onViewRemoved: widget.onViewRemoved,
    );
  }
        ...
        onNotification: (ScrollNotification notification) {
          ...
          if (notification is UserScrollNotification &&
            ...
            if (widget.onEndScroll != null) {
              widget.onEndScroll!(_inViewState?.inViewIds ?? []);
            }
          }

          if (!_streamController!.isClosed && isScrollDirection) {
            _streamController!.add(notification);
            if (widget.onStartScroll != null) {
