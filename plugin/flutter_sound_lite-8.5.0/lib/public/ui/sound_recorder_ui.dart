...
class SoundRecorderUI extends StatefulWidget {
  ...
  @override
  State<SoundRecorderUI> createState() {
...
class SoundRecorderUIState extends State<SoundRecorderUI> {
  ...
  Widget _buildButtons() {
    return Container(
        ...
        decoration: BoxDecoration(
            color: widget.backgroundColor ?? const Color(0xFFFAF0E6),
            borderRadius:
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            widget.showTrashCan ? _buildTrashButton() : const SizedBox(),
            Text(_isPaused
                ? widget.pausedTitle
                : _isRecording
  ...
  void _onStopped({bool? wasUser}) {
    setState(() {
      ...
      onRecordingStopped(context, const Duration(milliseconds: 2000));
    });
  }
